...
struct esp_netif_driver_ifconfig {
    ...
    esp_err_t (*transmit)(void *h, void *buffer, size_t len, int64_t *timestamp); /*!< transmit function pointer */
    esp_err_t (*transmit_wrap)(void *h, void *buffer, size_t len, void *netstack_buffer, int64_t *timestamp); /*!< transmit wrap function pointer */
